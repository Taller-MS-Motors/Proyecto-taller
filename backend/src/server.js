...
// Cloudflare Turnstile (captcha anti-bot): carga un script y un iframe desde
// challenges.cloudflare.com, y verifica por fetch. Se permite en script/frame/connect.
const CSP = [
  "default-src 'self'",
