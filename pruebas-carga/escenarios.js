...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{escenario:e1}': [`p(95)<${SLO.p95_escritura_ms}`],
    'http_req_duration{escenario:e2}': [`p(95)<${SLO.p95_ms}`],
    'http_req_duration{escenario:e3}': [`p(95)<${SLO.p95_escritura_ms}`],
    'http_req_duration{escenario:e4}': [`p(95)<${SLO.p95_ms}`],
    'http_req_duration{escenario:e5}': [`p(95)<${SLO.p95_ms}`],
    'http_req_duration{escenario:e6}': [`p(95)<${SLO.p95_ms}`],
